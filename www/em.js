...
//  $.getJSON('json/data/' + filename1 + '.json', function(data) {
    ...
    var grpName = rowX == 'ind' ? 'Year and Quarter' : $('#row_var option:selected').text();
      ...
      if(isTrend) {
        ...
        plotTraces = linePlotData(
         ...
         // hovertemplate= "hovertemplate",
          ...
          var y_max = Math.max.apply(null, ucl_y_line.filter(function (n) { return !isNaN(n); })) + 5;
       ...
       // hovertemplate= "hovertemplate";
        ...
        hideYaxis = false;
         ...
         // layout.yaxis = { tickformat: '0,.5', hoverformat: hoverfmt, title: 'Percent' };
          layout.yaxis = {tickformat: '0,.5', hoverformat: hoverfmt, range: [0, y_max], title: 'Percent' };
          //layout.xaxis = x.length < 15 ? { tickvals: x_values, ticktext: x_names, title: 'Year and Quarter' } : {};

         // layout.yaxis = { tickformat: '0,.5', hoverformat: hoverfmt, range: [0, 100], title: 'Percent' };
          layout.margin.l = 60;
          //layout.margin.l = 60;
...
//          '2018Q1', '2018Q2', '2018Q3', '2018Q4'],  title: 'Year'} : {};
    ...
    // Caption, Citation, Notes ---------------------------------------------------
      var fullCaption, fullCaption2, fullCaption3, plotCaption, plotCaption3, newSource, statName2;
...
//       $('#plot-caption2').text(plotCaption2);
      ...
      var today3 = new Date().toDateString().slice(4);
        var newCitation = NCHS + ". " + tableCaption + ". " + NHIS +
            ". Generated interactively: " + today3 + " from https://wwwn.cdc.gov/NHISDataQueryTool/ER_Quarterly/index_quarterly.html";
     ...
     //   ". Generated interactively: "+today.toDateString() +".";
      ...
      statNote = "";
        ...
        var qtrendNotes = $.grep([
            statNote,
            qmepsTrends[rowX],
            qmepsTrends[statName2]], Boolean).join("\n");
